...
import GuildIcon from '../components/guilds/guild-icon'
	...
	createStyles({
		...
		card: {
			...
			'&:hover': {
				...
				'& $cardAvatar': {
					transform:
						'perspective(1000px) translateY(-5px) translateZ(30px) rotateX(-3deg)',
	...
	return (
		...
		>
			...
			{guilds ? (
				...
				>
					<p style={{ display: 'inline-block', color: '#999999' }}>
						Don't see your server listed?
					</p>
					<a
						style={{
						...
						href="https://docs.oasisbot.xyz/getting-started#troubleshooting"
						target="_blank"
					>
						Find out why
					</a>
