...
import CustomCommandsIcon from '../../assets/guild-dashboard/custom_commands_icon.svg'
import PollIcon from '../../assets/guild-dashboard/poll_icon.svg'
import GiveawayIcon from '../../assets/guild-dashboard/giveaway_icon.svg'
import EmbedIcon from '../../assets/guild-dashboard/embed_icon.svg'
import ActionsIcon from '../../assets/guild-dashboard/actions_icon.svg'
import HelpIcon from '../../assets/guild-dashboard/help_icon.svg'
...
export default function Home({ guild }: HomeProps) {
	...
	const handleCardClick = (index: number) => {
		...
		switch (index) {
			case 0: {
				history.push(`${basePath}/commands`)
				break
			}
			case 1: {
				history.push(`${basePath}/polls`)
				break
			}
			case 2: {
				history.push(`${basePath}/giveaways`)
				break
			}
			case 3: {
				history.push(`${basePath}/embeds`)
				break
			}
			case 4: {
				history.push(`${basePath}/actions`)
				break
			}
			case 5: {
				history.push(`${basePath}/help`)
				break
			}
		}
	}
	...
	const handleRedirect = (index: number) => {
		switch (index) {
			case 0: {
				window.open('https://docs.oasisbot.xyz')
			}
		}
	}
		...
		<section className={classes.homeContainer}>
			...
			<div className={classes.cardContainer}>
				...
				>
					...
					<div style={{ marginLeft: '15px' }}>
						...
						<p>
							Create powerul commands that will level-up your
							server!
						</p>
					</div>
				</div>
				...
				>
					...
					<div style={{ marginLeft: '15px' }}>
						<h2>Polls</h2>
						<p>
							Create polls and surveys that members can vote for
						</p>
					</div>
				</div>
				<div
				...
				>
					...
					<div style={{ marginLeft: '15px' }}>
						<h2>Giveaways</h2>
						<p>
							Start giveaways that members can enter to win cool
							prizes!
						</p>
					</div>
				</div>
				...
				>
					...
					<div style={{ marginLeft: '15px' }}>
						<h2>Help</h2>
						<p>
							Override the default help command and add info about
							your server
						</p>
					</div>
				</div>
			...
			>
				<div>
					...
					<p>
						Everything you need to know about OasisBot and how to
						use it!
					</p>
				</div>
			</div>
			...
			<div className={classes.cardContainer}>
				...
				>
					<div>
						...
						<p>
							Learn how to manage your dashboard and assign others
						</p>
					</div>
				</div>
				<div
				...
				>
					<div>
						<h2>Custom Commands</h2>
						<p>
							Learn how to create custom commands and how to use
							them
						</p>
					</div>
				</div>
