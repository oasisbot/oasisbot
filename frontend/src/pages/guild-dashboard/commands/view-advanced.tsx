...
export interface CommandViewAdvancedProps {
    command: Command
    editing: boolean
    onClose: () => void
...
export default function CommandViewAdvanced ({ command, editing, onClose, onSave }: CommandViewAdvancedProps) {
    ...
    return (
        <div className={classes.root}>
            ...
            <h4 style={{color: '#bbbbbb', marginBottom: '10px'}}>GO TEMPLATE EDITOR V2</h4>
            <Info style={{marginBottom: '10px'}}>
                <p>
                    Advanced custom commands use <b>Go's templating library</b>. Learn how to make your own custom commands <a 
                    href='https://docs.oasisbot.xyz/dashboard-and-permissions#bot-masters'style={{color: '#4cc9f0'}}>here</a>
                </p>
            </Info>
            <TextAreaCounter variant='code' textAreaProps={{value: response, onChange: (value: string) => setResponse(value)}} maxLength={2000} color='#fb3640' />
            <CommonSettings
