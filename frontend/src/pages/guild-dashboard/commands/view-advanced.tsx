...
export default function CommandViewAdvanced({
	command,
	editing,
	onClose,
	onSave,
}: CommandViewAdvancedProps) {
	...
	return (
		<div className={classes.root}>
			...
			<Info style={{ marginBottom: '10px' }}>
				<p>
					Advanced custom commands use <b>Go's templating library</b>.
			...
			<TextAreaCounter
				...
				textAreaProps={{
					value: response,
					onChange: (value: string) => setResponse(value),
				}}
				maxLength={2000}
				color="#fb3640"
			/>
