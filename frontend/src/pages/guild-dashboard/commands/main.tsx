			...
			<div className={classes.content}>
				...
				<div className={classes.actionCardContainer}>
					<div
						...
						onClick={() => onCommandSelect(undefined, 0)}
					>
						<h2>Basic</h2>
						<p>
							A basic command that responds with text to the user
							that issued the command
						</p>
					</div>
					<div
						className={classes.actionCard}
						onClick={() => onCommandSelect(undefined, 1)}
					>
						<h2>Randomized</h2>
						<p>
							A command with multiple responses randomly chosen
							each time
						</p>
					</div>
					<div className={classes.actionCard}>
						<h2>Embed</h2>
						<p>
							Sends a really cool formatted embed message along
							with some optional text
						</p>
					</div>
					<div
						className={classes.actionCard}
						onClick={() => onCommandSelect(undefined, 3)}
					>
						<h2>Role</h2>
						<p>
							Assigns a specific role to the user that issued the
							command
						</p>
					</div>
					<div
						className={classes.actionCard}
						onClick={() => onCommandSelect(undefined, 4)}
					>
						<h2>Advanced</h2>
						<p>
							Commands with parameters that can add or remove
							roles and do even more!
						</p>
					</div>
				</div>
				<div
				...
				>
					<h2 style={{ color: '#dddddd', display: 'inline-block' }}>
						COMMANDS
					</h2>
					<h2
						style={{
